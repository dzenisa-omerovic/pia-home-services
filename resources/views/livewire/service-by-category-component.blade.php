<div>
    <div class="section-title-01 honmob">
        ...
        <div class="opacy_bg_02">
            <div class="container">
                <h1>{{ $scategory ? $scategory->name : 'Services' }}</h1>
                <div class="crumbs">
                    <ul>
                        <li><a href="/">Home</a></li>
                        <li>/</li>
                        <li>{{ $scategory ? $scategory->name : 'Category' }}</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="content-central">
        <div class="container">
            <div class="row" style="margin-top: -30px;">
                <div class="titles">
                    <h2>{{ $scategory ? $scategory->name : 'Category' }} <span>Services</span></h2>
            ...
            <div>
                <div class="container">
                    <div class="portfolioContainer">
                        ...
                        @elseif($scategory->services->count() > 0)
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 nature hsgrids"
                            ...
                            <a class="g-list" href="{{ route('home.service_details', ['service_slug' => $service->slug]) }}">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <hr class="separator">
                                    <p>{{$service->tagline}}</p>
                                    <div class="content-btn"><a href="service-details/{{$scategory->name}}-wet-servicing.html"
