                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateService">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{ $sprovider && $sprovider->category ? $sprovider->category->name : '—' }}" readonly/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @else
                                                    <img src="{{ asset('images/services/thumbnails') }}/{{ $thumbnail }}" width="120"/>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @else
                                                    <img src="{{ asset('images/services') }}/{{ $image }}" width="120"/>
                                                @endif
                                            </div>
                                        </div>
